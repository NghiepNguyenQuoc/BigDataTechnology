...
public class AverageTemp extends Configured implements Tool {
	...
	public static class AverageTempMapper extends
		...
		public void map(LongWritable key, Text value, Context context)
			...
			context.write(year, new PairWritable(airTemp, one));
		}
	}

	public static class AverageTempCombiner extends
			Reducer<IntWritable, PairWritable, IntWritable, PairWritable> {

		@Override
		public void reduce(IntWritable key, Iterable<PairWritable> values,
				Context context) throws IOException, InterruptedException {
			System.out.println("Custom Combiner");
			int sum = 0;
			int count = 0;
			...
			context.write(key, new PairWritable(new IntWritable(sum),
	...
	public int run(String[] args) throws Exception {
		...
		job.setCombinerClass(AverageTempCombiner.class);
