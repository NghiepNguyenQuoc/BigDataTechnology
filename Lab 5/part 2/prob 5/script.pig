...
USERS = LOAD '/home/cloudera/Desktop/MovieDataSet/users.txt' AS (userId: int, age: int, gender:chararray, occupation: chararray, zipCode: chararray);
...
joinUR20 = JOIN joinUR BY  movieId, top20 BY movieId;
newDataSet = FOREACH joinUR20 GENERATE RATING.movieId, top20.Title, RATING.timestamp; 
