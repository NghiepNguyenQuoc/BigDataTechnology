...
public class AvroGenericStationTempYear extends Configured implements Tool
{
	...
	public static class AvroMapper extends Mapper<// complete this line by adding parameters>
	{
	...
	public int run(String[] args) throws Exception
	{
		...
		//job.setOutputFormatClass(AvroKeyOutputFormat.class);	//Uncomment this line
