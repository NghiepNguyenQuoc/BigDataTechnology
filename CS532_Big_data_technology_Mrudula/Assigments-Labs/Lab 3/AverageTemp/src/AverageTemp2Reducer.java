...
public class AverageTemp2Reducer extends Configured implements Tool {
	...
	public static class YearPartitioner extends Partitioner<SortWritable, PairWritable> {
	    
		@Override
	    public int getPartition(SortWritable key, PairWritable value, int numReduceTasks) {
	        if(key.getVal() < 1930) {
	            return 0;
	        }
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(conf, new AverageTemp2Reducer(), args);
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(AverageTemp2Reducer.class);
