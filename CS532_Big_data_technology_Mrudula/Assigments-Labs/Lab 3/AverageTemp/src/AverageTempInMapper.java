...
public class AverageTempInMapper extends Configured implements Tool {
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(conf, new AverageTempInMapper(), args);
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(AverageTempInMapper.class);
