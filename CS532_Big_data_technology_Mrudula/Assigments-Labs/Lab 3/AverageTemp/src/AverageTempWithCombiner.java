...
public class AverageTempWithCombiner extends Configured implements Tool {
	...
	public static class Combiner extends
		...
		@Override
		protected void reduce(Text key, Iterable<PairWritable> values,
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(conf, new AverageTempWithCombiner(), args);
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(AverageTempWithCombiner.class);
